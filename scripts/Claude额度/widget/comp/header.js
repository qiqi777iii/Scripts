...
function View({ plan }) {
    const size = 19;
    return (createElement(scripting_1.Link, { url: "https://claude.ai", buttonStyle: "plain" },
        createElement(scripting_1.HStack, null,
            ...
            createElement(scripting_1.Text, { font: "headline", padding: { top: -2, leading: 4 } }, "Claude"),
