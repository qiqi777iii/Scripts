...
| [番号快速搜索](userscripts/search-av-mobile.user.js) | 识别网页番号，并提供面向移动端的快捷搜索功能。 | [安装 / 更新](https://raw.githubusercontent.com/qiqi777iii/QiQi-Safari-script/main/userscripts/search-av-mobile.user.js) |
