...
| 模块 | 功能 | 安装 |
| --- | --- | --- |
| 根据出口IP切换出站模式 | 网络变化后检查 DIRECT 出口；中国 IP 切换为规则模式，非中国 IP 切换为直接连接。 | [安装](https://raw.githubusercontent.com/qiqi777iii/Scripts/main/surge/switch-outbound-mode-by-ip.sgmodule) |

## Scripting App 脚本包

| 脚本包 | 用途 | 项目链接 |
| --- | --- | --- |
| Claude额度 | 查看 Claude 使用额度。 | [复制链接](https://github.com/qiqi777iii/Scripts/tree/main/scripts/ClaudeUsage) |
| Codex额度 | 查看 Codex 使用额度。 | [复制链接](https://github.com/qiqi777iii/Scripts/tree/main/scripts/CodexUsage) |
